  ...
  const mockArtists: Artist[] = [
    {
      ...
      portfolioImages: [
        { id: '1', imageUrl: getDiscoverPlaceholder(), title: 'Abstract Harmony', description: 'A vibrant exploration of color', medium: 'Oil on Canvas', year: '2023', tags: ['abstract', 'color'], createdAt: new Date() },
        { id: '2', imageUrl: getDiscoverPlaceholder(), title: 'Emotional Landscapes', description: 'Deep emotional expression', medium: 'Acrylic', year: '2023', tags: ['abstract', 'emotion'], createdAt: new Date() },
        { id: '3', imageUrl: getDiscoverPlaceholder(), title: 'Color Symphony', description: 'Harmonious color composition', medium: 'Mixed Media', year: '2023', tags: ['abstract', 'color'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      id: 'artist-2',
      name: 'Marcus Chen',
      ...
      portfolioImages: [
        { id: '4', imageUrl: getDiscoverPlaceholder(), title: 'Digital Dreams', description: 'Futuristic cityscape', medium: 'Digital Art', year: '2023', tags: ['digital', 'urban'], createdAt: new Date() },
        { id: '5', imageUrl: getDiscoverPlaceholder(), title: 'Urban Reflections', description: 'City life exploration', medium: 'Mixed Media', year: '2023', tags: ['urban', 'reflection'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '6', imageUrl: getDiscoverPlaceholder(), title: 'Ceramic Contemplation', description: 'Thoughtful ceramic work', medium: 'Ceramic', year: '2023', tags: ['sculpture', 'ceramic'], createdAt: new Date() },
        { id: '7', imageUrl: getDiscoverPlaceholder(), title: 'Bronze Identity', description: 'Identity exploration in bronze', medium: 'Bronze', year: '2023', tags: ['sculpture', 'bronze'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '8', imageUrl: getDiscoverPlaceholder(), title: 'Cherry Blossom Dreams', description: 'Traditional watercolor of spring', medium: 'Watercolor', year: '2023', tags: ['watercolor', 'nature'], createdAt: new Date() },
        { id: '9', imageUrl: getDiscoverPlaceholder(), title: 'Tokyo Nights', description: 'Urban watercolor scene', medium: 'Watercolor', year: '2023', tags: ['watercolor', 'urban'], createdAt: new Date() },
        { id: '10', imageUrl: getDiscoverPlaceholder(), title: 'Mountain Serenity', description: 'Peaceful mountain landscape', medium: 'Watercolor', year: '2023', tags: ['watercolor', 'landscape'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '11', imageUrl: getDiscoverPlaceholder(), title: 'Cultural Heritage', description: 'Celebrating Mexican traditions', medium: 'Oil on Canvas', year: '2023', tags: ['oil', 'culture'], createdAt: new Date() },
        { id: '12', imageUrl: getDiscoverPlaceholder(), title: 'Feminine Strength', description: 'Portrait of empowerment', medium: 'Oil on Canvas', year: '2023', tags: ['oil', 'portrait'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '13', imageUrl: getDiscoverPlaceholder(), title: 'Memory Fragments', description: 'Mixed media installation', medium: 'Mixed Media', year: '2023', tags: ['mixed-media', 'memory'], createdAt: new Date() },
        { id: '14', imageUrl: getDiscoverPlaceholder(), title: 'Cultural Tapestry', description: 'Textile and digital fusion', medium: 'Mixed Media', year: '2023', tags: ['mixed-media', 'textile'], createdAt: new Date() },
        { id: '15', imageUrl: getDiscoverPlaceholder(), title: 'Digital Memories', description: 'Technology meets tradition', medium: 'Mixed Media', year: '2023', tags: ['mixed-media', 'digital'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '16', imageUrl: getDiscoverPlaceholder(), title: 'Organic Forms', description: 'Natural ceramic shapes', medium: 'Ceramic', year: '2023', tags: ['ceramic', 'organic'], createdAt: new Date() },
        { id: '17', imageUrl: getDiscoverPlaceholder(), title: 'Functional Art', description: 'Beautiful and useful ceramics', medium: 'Ceramic', year: '2023', tags: ['ceramic', 'functional'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '18', imageUrl: getDiscoverPlaceholder(), title: 'Street Stories', description: 'Urban life documentation', medium: 'Photography', year: '2023', tags: ['photography', 'street'], createdAt: new Date() },
        { id: '19', imageUrl: getDiscoverPlaceholder(), title: 'Cultural Mosaic', description: 'Diverse community portraits', medium: 'Photography', year: '2023', tags: ['photography', 'culture'], createdAt: new Date() },
        { id: '20', imageUrl: getDiscoverPlaceholder(), title: 'Digital Dreams', description: 'Surreal digital manipulation', medium: 'Digital Art', year: '2023', tags: ['digital', 'surreal'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '21', imageUrl: getDiscoverPlaceholder(), title: 'Nordic Textiles', description: 'Traditional patterns reimagined', medium: 'Textile', year: '2023', tags: ['textile', 'nordic'], createdAt: new Date() },
        { id: '22', imageUrl: getDiscoverPlaceholder(), title: 'Nature Weavings', description: 'Organic textile forms', medium: 'Textile', year: '2023', tags: ['textile', 'nature'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '23', imageUrl: getDiscoverPlaceholder(), title: 'Sacred Script', description: 'Traditional Arabic calligraphy', medium: 'Ink on Paper', year: '2023', tags: ['calligraphy', 'traditional'], createdAt: new Date() },
        { id: '24', imageUrl: getDiscoverPlaceholder(), title: 'Modern Verses', description: 'Contemporary calligraphic art', medium: 'Mixed Media', year: '2023', tags: ['calligraphy', 'contemporary'], createdAt: new Date() },
        { id: '25', imageUrl: getDiscoverPlaceholder(), title: 'Cultural Bridge', description: 'East meets West in script', medium: 'Mixed Media', year: '2023', tags: ['calligraphy', 'cultural'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '26', imageUrl: getDiscoverPlaceholder(), title: 'Community Mural', description: 'Vibrant street art celebrating unity', medium: 'Spray Paint', year: '2023', tags: ['street-art', 'community'], createdAt: new Date() },
        { id: '27', imageUrl: getDiscoverPlaceholder(), title: 'Social Justice', description: 'Art for change and awareness', medium: 'Mixed Media', year: '2023', tags: ['street-art', 'social'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '28', imageUrl: getDiscoverPlaceholder(), title: 'Outback Dreams', description: 'Vast Australian landscapes', medium: 'Oil on Canvas', year: '2023', tags: ['landscape', 'australia'], createdAt: new Date() },
        { id: '29', imageUrl: getDiscoverPlaceholder(), title: 'Coastal Serenity', description: 'Peaceful beach scenes', medium: 'Oil on Canvas', year: '2023', tags: ['landscape', 'coastal'], createdAt: new Date() },
        { id: '30', imageUrl: getDiscoverPlaceholder(), title: 'Desert Sunsets', description: 'Golden hour in the outback', medium: 'Oil on Canvas', year: '2023', tags: ['landscape', 'desert'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '31', imageUrl: getDiscoverPlaceholder(), title: 'Traditional Tales', description: 'Classic miniature storytelling', medium: 'Miniature Painting', year: '2023', tags: ['miniature', 'traditional'], createdAt: new Date() },
        { id: '32', imageUrl: getDiscoverPlaceholder(), title: 'Modern Narratives', description: 'Contemporary themes in miniature', medium: 'Miniature Painting', year: '2023', tags: ['miniature', 'contemporary'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '33', imageUrl: getDiscoverPlaceholder(), title: 'Reclaimed Beauty', description: 'Sculpture from salvaged wood', medium: 'Wood Sculpture', year: '2023', tags: ['sculpture', 'wood'], createdAt: new Date() },
        { id: '34', imageUrl: getDiscoverPlaceholder(), title: 'Natural Forms', description: 'Organic shapes in wood', medium: 'Wood Sculpture', year: '2023', tags: ['sculpture', 'organic'], createdAt: new Date() },
        { id: '35', imageUrl: getDiscoverPlaceholder(), title: 'Sustainable Art', description: 'Eco-conscious sculptural work', medium: 'Wood Sculpture', year: '2023', tags: ['sculpture', 'sustainable'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
    },
    {
      ...
      portfolioImages: [
        { id: '36', imageUrl: getDiscoverPlaceholder(), title: 'Paper Installations', description: 'Large-scale paper artworks', medium: 'Paper Installation', year: '2023', tags: ['paper', 'installation'], createdAt: new Date() },
        { id: '37', imageUrl: getDiscoverPlaceholder(), title: 'Traditional Craft', description: 'Handmade paper techniques', medium: 'Handmade Paper', year: '2023', tags: ['paper', 'traditional'], createdAt: new Date() }
      ],
      events: [],
      courses: [],
      discoverThumbnail: getDiscoverPlaceholder()
